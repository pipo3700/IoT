...
public class Funcion_Recurso extends Recurso {
	...
	public Representation put(Representation entity) {
		...
		if (!dispositivo.isHabilitado()) {
			String message = "No se pueden modificar las funciones de un dispositivo deshabilitado";
			return this.generateResponseWithErrorCodeAndMessage(Status.CLIENT_ERROR_FORBIDDEN, message);
		}
